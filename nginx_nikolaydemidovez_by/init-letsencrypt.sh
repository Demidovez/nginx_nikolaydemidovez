...
domains=(nikolaydemidovez.by club.nikolaydemidovez.by admin.nikolaydemidovez.by)
rsa_key_size=4096
data_path="./certbot"
email="nikolaydemidovez@gmail.com" # Adding a valid address is strongly recommended
staging=0 # Set to 1 if you're testing your setup to avoid hitting request limits
container_nginx="nginx_nikolaydemidovez_by"
container_certbot="certbot_nikolaydemidovez_by"
